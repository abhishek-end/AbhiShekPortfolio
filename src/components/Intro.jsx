...
const Intro = () => {
  ...
  return (
    <div className='flex justify-center items-center h-screen w-full mt-48 '>
      <div className='flex  justify-center px-10 flex-col items-start w-1/2 h-[56%] border-r-[1px] '>
        <div className='hello-world text-white text-9xl  font-bold font-oswald '>
        ...
        <div className='more text-white font-gugi  mt-12  text-2xl capitalize font-bold flex items-center justify-start gap-4 '>
