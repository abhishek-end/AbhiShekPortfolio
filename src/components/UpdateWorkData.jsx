    ...
    >
      ...
      <div className='w-full h-full  lg:mt-10 '>
        {data.map((item, index) => (
          ...
          >
            <div className='hover:px-4 lg:hover:px-10 transition-all flex  w-full  justify-between h-full rounded-full items-center '>
        ...
        <div
          className='mt-5 md:px-6 '
          ref={(el) => (textRef.current[data.length] = el)}
        >
