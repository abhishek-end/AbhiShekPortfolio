      ...
      <div className=' w-full text-white scaleX '>
        <div className='w-full  h-full relative group p-2 '>
          ...
          >
            <img
              src={link}
              className='w-full  md:h-[900px] h-[450px]  object-cover  border-8 border-[#fac230] rounded-2xl hover:scale-90 hover:opacity-50 transition-transform duration-300 opacity-70 p-1'
